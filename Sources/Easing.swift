...
public enum Easing {
    ...
    */
    public func calculate<T: DoubleConvertable>(_ g: T) -> T {
        return T(_calculate(g1: 0, d1: 0, g2: 1, d2: 1, g: g.asDouble()))
    }
    
    /**
     Calculate value g where g1 = 0, d1 = d1, g2 = 1, d2 = d2
    */
    public func calculate<T: DoubleConvertable>(d1: T, d2: T, g: T) -> T {
        return T(_calculate(g1: 0, d1: d1.asDouble(), g2: 1, d2: d2.asDouble(), g: g.asDouble()))
    }
    ...
    */
    public func calculate<T: DoubleConvertable>(g1: T, d1: T, g2: T, d2: T, g: T) -> T {
        return T(_calculate(g1: g1.asDouble(), d1: d1.asDouble(), g2: g2.asDouble(), d2: d2.asDouble(), g: g.asDouble()))
    }
    
    private func _calculate(g1: Double, d1: Double, g2: Double, d2: Double, g: Double) -> Double {
    ...
    private var easingFunction: (Double)->Double {
        ...
        case .cubicBezier(let x1, let y1, let x2, let y2):
            return {(p: Double) -> Double in
                return Easing._cubicBezier(p, x1: x1, y1: y1, x2: x2, y2: y2)
            }
        }
    }
